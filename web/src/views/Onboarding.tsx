...
// energy + a privacy note. Port of Views/Onboarding/SetupView.swift. (The
// on-device AI step is replaced with a "coming soon" note on web.)
    ...
    <div className="flex min-h-screen flex-col bg-canvas">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-8">
        ...
        {step === 2 && (
          ...
          >
            <Card>
              <div className="text-[14px] font-semibold text-accent">🔒 Your data never leaves your browser</div>
              <p className="mt-2 text-[13px] text-secondary">
                Your check-ins live only in this browser's local storage. We run no server, and scoring and
                coaching are always available via the built-in rule-based coach.
              </p>
            </Card>
            <p className="mt-4 text-[13px] text-secondary">
              An optional on-device AI coach can warm up the coaching prose — it runs an open-source model
              entirely in your browser, so prompts never leave this device. Enable it anytime in Settings;
